...
# do login
def __do_login(request,_username,_password,post_check_code):
    _state = __check_login(request,_username,_password,post_check_code)
    if _state['success']:
...
def __check_login(request,_username,_password,post_check_code):
    _state = {
        'success' : True,
        'message' : 'none',
        'userid' : -1,
...
def signin(request):
    ...
    # check username and password
    if _is_post:
        _state = __do_login(request,_username,_password,post_check_code)
